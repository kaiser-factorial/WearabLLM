...
class SourceManifestTest(unittest.TestCase):
    ...
    def test_staged_space_contains_runtime_and_source_bundle(self) -> None:
        ...
        self.assertIn("bridge/model_pipeline.py", relative)
        self.assertIn("bridge/model_protocol.py", relative)
        ...
        self.assertIn("bridge/protocol_usage.py", relative)
        ...
        self.assertIn("COPY bridge/model_pipeline.py ./model_pipeline.py", dockerfile)
        ...
        self.assertIn("COPY bridge/protocol_usage.py ./protocol_usage.py", dockerfile)
